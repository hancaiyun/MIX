layui.define(["form"], function (exports) {
  ...
  const $ = layui.$,
      ...
      cron = {
        ...
        //主体CSS等待事件
        ready: function (fn) {
          const cssPath = layui.cache.base + "cron/cron.css?v=" + cron.v;
  ...
  Class.prototype.render = function () {
    ...
    const $elemCron = (that.$elemCron = $('<div class="layui-cron"></div>')),
        // 主区域
        elemMain = [], // tabs容器
  ...
  Class.prototype.tool = function (btn, type) {
    var that = this,
      ...
      active = {
        ...
        calYears: function () {
          const data = form.val("cronYearForm"),
        ...
        run: function () {
          ...
          const cronStr = that.cron.join(" ").trim();
